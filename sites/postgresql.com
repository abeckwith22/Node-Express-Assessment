...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2024-05-21T19:35:21.490906" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pg_dumpbinary-v217-released-2862/">pg_dumpbinary v2.17 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-05-20 by Gilles Darold</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgday-israel-2024-call-for-papers-is-now-open-2857/">PGDay Israel 2024: Call for Papers is Now Open!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-05-19 by Israel PostgreSQL Community</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgpool-ii-452-447-4310-4217-and-4120-released-2859/">Pgpool-II 4.5.2, 4.4.7, 4.3.10, 4.2.17 and 4.1.20 released.</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-05-19 by Pgpool Global Development Group</li>
              </ul>
            </li>
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6vb"> 16 Years After The Launch of 2ndQuadrant Italy: Remembering Simon Riggs</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6va"> New compilers, new timings</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6vm"> PostgreSQL 17: part 4 or CommitFest 2024-01</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6vl"> 🎙️ Ship It Podcast — PostgreSQL with Andrew Atkinson</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6v9"> Introducing pg_timeseries: Open-source time-series extension for PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Samay Sharma</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-05-20</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6v8"> In-memory disk for PostgreSQL temporary files</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6v7"> Upgrade PostgreSQL from 15 to 16 on Ubuntu 24.04</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Paolo Melchiorre</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-05-19</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6v6"> Deep Dive into PostgREST - Time Off Manager (Part 2)</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Radim Marek</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-05-18</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6v5"> Understand PostgerSQL’s Portal – Executor vs Process Utility</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;cary huang</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-05-17</li>
            </ul>
          </div>
        </div>
